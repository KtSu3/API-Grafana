...
id_to_department = {
   '5bf73d1d186f7d2b0d647a60': 'Comercial',
    ...
    '5d1623f35e74a002308aa25d': 'Torre de controle',
...
id_to_agent = {
    ...
    '65d606bdfc89ce8dc65e86dc': 'Alessandro Renegociacões', #OK
    ...
    '65770b3980f205f2d5b4beee': 'Daiana Operacional', #OK
    '652da4ae9717665daea8eee1': 'Daniel Projeto', #OK
    '64d51db12eafcbb48bfe755a': 'Daniele Retencao', #OK
    '64d51de2077494074fa85981': 'Daniely Operacional', #OK
    ...
    '6602c86119884447a0acef9c': 'Rodrigo Operacional', #OK
    ...
    '65f1e362411ea3e1afd65e3e': 'Michelle Operacional', #OK
    ...
    '64d51491077494074fa856e7': 'Debora Silva Comercial',
    '64d51e132eafcbb48bfe75d5': 'Stefane Operacional',
...
def insert_table(connection, data, data2):
    try:
        ...
        cursor.execute("TRUNCATE TABLE aguardando_atendimento;")
